(function() {
	...
	module.exports = function(grunt, config) {
		...
		config.libraries.forEach(function(oLibrary) {
			...
			sapui5lib_buildpreload['target-' + oLibrary.name]['files'][sLibraryTarget + '/resources/library-preload.json'] = [sLibraryTarget + '/**/*.js', sLibraryTarget + '/**/*.xml', sLibraryTarget + '/**/*.properties'];
		});
